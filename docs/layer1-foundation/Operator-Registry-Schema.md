...
- Required fields per operator record:
  ...
  - `side_effects:array<side_effect_enum>` (sorted, unique; enum from `docs/layer1-foundation/Data-Structures.md`)
  - `allowed_error_codes:array<error_code_id>` (sorted, unique; ids from `docs/layer1-foundation/Error-Codes.md`)
